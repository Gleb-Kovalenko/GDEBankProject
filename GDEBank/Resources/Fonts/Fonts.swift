...
public typealias FontTypeAlias = FontConvertible.Font
...
public enum SGFontFamily {
  public enum SFProText {
    public static let ultralight = FontConvertible(name: "SFProText-Ultralight", family: "SF Pro Text", path: "PaxilPayFont.otf")
    public static let all: [FontConvertible] = [ultralight]
  }
